 ...
 */
public class AppendLogEntriesResultMessageSerializer extends AbstractDistributableSerializer {

    private final Schema<AppendLogEntriesResultMessage> schema = RuntimeSchema
        .getSchema(AppendLogEntriesResultMessage.class);

    public AppendLogEntriesResultMessageSerializer(Pool<LinkedBuffer> pool) {
        super(pool);
    }
