 ...
 */
public class InstallSnapshotResultMessageSerializer extends AbstractDistributableSerializer {

    private final Schema<InstallSnapshotResultMessage> schema = RuntimeSchema
        .getSchema(InstallSnapshotResultMessage.class);

    public InstallSnapshotResultMessageSerializer(Pool<LinkedBuffer> pool) {
        super(pool);
    }
