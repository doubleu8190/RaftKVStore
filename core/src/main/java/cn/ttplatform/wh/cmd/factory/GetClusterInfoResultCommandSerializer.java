 ...
 */
public class GetClusterInfoResultCommandSerializer extends AbstractDistributableSerializer {

    private final Schema<GetClusterInfoResultCommand> schema = RuntimeSchema.getSchema(GetClusterInfoResultCommand.class);

    public GetClusterInfoResultCommandSerializer(Pool<LinkedBuffer> pool) {
        super(pool);
    }
