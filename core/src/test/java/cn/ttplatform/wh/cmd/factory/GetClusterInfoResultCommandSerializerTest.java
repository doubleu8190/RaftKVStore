 ...
 */
@Slf4j
public class GetClusterInfoResultCommandSerializerTest {

    GetClusterInfoResultCommandSerializer factory;

    @Before
    public void setUp() throws Exception {
        Pool<LinkedBuffer> pool = new FixedSizeLinkedBufferPool(10);
        factory = new GetClusterInfoResultCommandSerializer(pool);
    }
